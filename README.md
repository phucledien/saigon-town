...
- One full-viewport game screen with a fixed player HUD, solid, high-contrast six-stop zodiac wheel, bottom action belt, and a collapsible shop rack. No page scrolling is needed to reach controls. There is no district shortcut bar or zoom-button toolbar; two-finger pinching controls map scale.
