...
local OUT='/private/tmp/vietnamtown-v4-board/'
local W,H=1100,730
...
sprite:saveAs(OUT..'saigon-city-board-v4.aseprite')
sprite:saveCopyAs(OUT..'saigon-city-board-v4.png')
print('Saved original layered Aseprite board: '..OUT..'saigon-city-board-v4.png')
