...
Original pixel artwork drawn and exported in native Aseprite with `draw-saigon-v9-assets.lua`.

- `chieu-mat-tile.aseprite`: seamless 96×96 straw weave with restrained red and green dyed bands; exported as `dist/assets/ui/chieu-mat-v9.png`.
